...
try:
    from .video_utils import compute_deformation, estimate_speed
except ImportError:
...
def root():
    return {
        "status": "running",
        "service": "Nirikshan - Accident Detection API",
        "version": "1.0.0",
        "message": "Real-time road accident detection using YOLOv11"
    }
